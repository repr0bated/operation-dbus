...
use crate::mcp::introspection_parser::{IntrospectionData, IntrospectionParser};
...
impl AutoGeneratedPlugin {
    ...
    async fn introspect_service(
        ...
        Ok(IntrospectionParser::parse_xml(&xml))
    }
...
impl PluginDiscovery {
    ...
    pub async fn create_plugins() -> Result<Vec<Box<dyn StatePlugin>>> {
        let services = Self::discover_services().await?;
        let mut plugins: Vec<Box<dyn StatePlugin>> = Vec::new();
