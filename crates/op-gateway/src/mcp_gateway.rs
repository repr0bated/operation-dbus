...
use crate::wireguard_auth::{WireGuardAuthManager, WireGuardSession, ClientInfo, SessionFilter};
use anyhow::Result;
...
impl McpGatewayManager {
    ...
    pub async fn dbus_route_client(&self, client_name: &str, auth_token: Option<&str>, peer_pubkey: Option<&str>) -> Result<Value> {
