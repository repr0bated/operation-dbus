...
impl Tool for DbusDinitStartServiceTool {
    ...
    async fn execute(&self, input: Value) -> Result<Value> {
        ...
        Ok(json!({ "started": true, "service": service, "manager": "dinit", "protocol": "dinitctl" }))
    }
...
impl Tool for DbusDinitStopServiceTool {
    ...
    async fn execute(&self, input: Value) -> Result<Value> {
        ...
        Ok(json!({ "stopped": true, "service": service, "manager": "dinit", "protocol": "dinitctl" }))
    }
...
impl Tool for DbusDinitStatusTool {
    ...
    async fn execute(&self, input: Value) -> Result<Value> {
        ...
        Ok(json!({ "service": service, "status": status, "manager": "dinit", "protocol": "dinitctl" }))
    }
