...
const AGENTS: &[AgentConfig] = &[
    ...
    AgentConfig { agent_type: "memory", auto_start: true, priority: 100 },
    AgentConfig { agent_type: "context-manager", auto_start: true, priority: 100 },
    AgentConfig { agent_type: "sequential-thinking", auto_start: true, priority: 100 },
    AgentConfig { agent_type: "dx-optimizer", auto_start: true, priority: 95 },
    AgentConfig { agent_type: "tdd-orchestrator", auto_start: true, priority: 95 },

    // Language & Architecture (High)
    AgentConfig { agent_type: "rust-pro", auto_start: true, priority: 90 },
    AgentConfig { agent_type: "python-pro", auto_start: true, priority: 90 },
    AgentConfig { agent_type: "backend-architect", auto_start: true, priority: 90 },
    AgentConfig { agent_type: "frontend-developer", auto_start: true, priority: 90 },
    AgentConfig { agent_type: "database-architect", auto_start: true, priority: 85 },
    AgentConfig { agent_type: "backend-security-coder", auto_start: true, priority: 85 },

    // Infrastructure & Ops (Medium)
    AgentConfig { agent_type: "network-engineer", auto_start: true, priority: 80 },
    AgentConfig { agent_type: "deployment", auto_start: true, priority: 80 },
    AgentConfig { agent_type: "devops-troubleshooter", auto_start: true, priority: 80 },

    // Analysis & Quality (Medium)
    AgentConfig { agent_type: "debugger", auto_start: true, priority: 75 },
    AgentConfig { agent_type: "code-reviewer", auto_start: true, priority: 75 },
    AgentConfig { agent_type: "search-specialist", auto_start: true, priority: 75 },
    AgentConfig { agent_type: "prompt-engineer", auto_start: true, priority: 70 },
    AgentConfig { agent_type: "docs-architect", auto_start: true, priority: 70 },
];
